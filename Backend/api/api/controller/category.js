...
exports.getCategory=function(req,res,next){
    ...
    var getPassCat= passCatModel.find({user_id:id},{'category_name':1,'_id':1});
    getPassCat.exec()
    .then(data=>{
        res.status(200).json({
            message:"OK",
    ...
    exports.addCategory=function(req,res,next){
        ...
        var passCatDetails=new passCatModel({category_name:passCategory,user_id:user_id});
        passCatDetails.save()
        .then(doc=>{
            res.status(201).json({
        ...
        exports.addUpdateCategory=function(req,res,next){
            ...
            passCatModel.findById(id,function(err,data){
             ...
             data.category_name=passCategory?passCategory:data.category_name;
                 data.save()
                 .then(doc=>{
                    res.status(201).json({
